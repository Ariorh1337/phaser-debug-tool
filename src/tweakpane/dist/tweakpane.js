...
(function (global, factory) {
    ...
    class RackApi extends BladeApi {
        ...
        addFolder(params) {
            const child = addFolderAsBlade(this, params);
    ...
    class FolderApi extends RackLikeApi {
        ...
        addFolder(params) {
            const child = this.rackApi_.addFolder(params);
    ...
    class FolderView {
        constructor(doc, config) {
            ...
            const buttonElement = doc.createElement('div');
            buttonElement.classList.add(this.className_('b'));
            ...
            bindValueToTextContent(config.props.value('title'), titleElem);
            buttonElement.appendChild(titleElem);
            this.titleElement = titleElem;
            this.buttonElement = titleElem;

            const right = doc.createElement('div');
            right.classList.add(this.className_('e'));
            buttonElement.appendChild(right);

            const place1 = doc.createElement('div');
            place1.setAttribute("name", "place1");
            place1.classList.add(this.className_('q'));
            right.appendChild(place1);

            const place2 = doc.createElement('div');
            place2.setAttribute("name", "place2");
    ...
    class Pane extends RootApi {
        ...
        setUpDefaultPlugins_() {
            ...
            embedStyle(this.document, 'default', CSS());
...
.tp-rotv {
    ...
    --cnt-h-p: var(--tp-container-horizontal-padding, 4px);
    --cnt-v-p: var(--tp-container-vertical-padding, 4px);
    --elm-br: var(--tp-element-border-radius, 2px);
    --bld-s: var(--tp-blade-spacing, 4px);
    --bld-us: var(--tp-blade-unit-size, 20px);
    --bs-bg: var(--tp-base-background-color, hsl(230deg, 7%, 17%));
    --bs-sh: var(--tp-base-shadow-color, rgba(0, 0, 0, 0.2));
    --btn-bg: var(--tp-button-background-color, hsl(230deg, 7%, 70%));
    ...
    --btn-fg: var(--tp-button-foreground-color, hsl(230deg, 7%, 17%));
    ...
    --cnt-fg: var(--tp-container-foreground-color, hsl(230deg, 7%, 75%));
    ...
    --in-fg: var(--tp-input-foreground-color, hsl(230deg, 7%, 75%));
...
.tp-tabv_c .tp-brkv>.tp-fldv>.tp-fldv_b,
.tp-fldv_c>.tp-fldv>.tp-fldv_b {
    border-top-left-radius: var(--elm-br);
    border-bottom-left-radius: var(--elm-br);
    display: flex;
    justify-content: space-between;
}

.tp-tabv_c .tp-brkv>.tp-fldv.tp-fldv-expanded>.tp-fldv_b,
.tp-fldv_c>.tp-fldv.tp-fldv-expanded>.tp-fldv_b {
    border-bottom-left-radius: 0
}

.tp-tabv_c .tp-brkv .tp-fldv>.tp-fldv_c,
.tp-fldv_c .tp-fldv>.tp-fldv_c {
    border-bottom-left-radius: var(--elm-br)
}

.tp-tabv_c .tp-brkv>.tp-tabv>.tp-tabv_i,
.tp-fldv_c>.tp-tabv>.tp-tabv_i {
    border-top-left-radius: var(--elm-br)
}

.tp-tabv_c .tp-brkv .tp-tabv>.tp-tabv_c,
...
div.tp-fldv_c > div.tp-fldv:first-child {
    margin-bottom: 1px;
}
...
.tp-fldv_c {
    border-left: var(--cnt-bg) solid 4px
}

.tp-fldv_b:hover+.tp-fldv_c {
    border-left-color: var(--cnt-bg-h)
}

.tp-fldv_b:focus+.tp-fldv_c {
    border-left-color: var(--cnt-bg-f)
}

.tp-fldv_b:active+.tp-fldv_c {
    border-left-color: var(--cnt-bg-a)
}
...
.tp-p2dpv {
    padding-left: calc(var(--bld-us) + 4px)
}
...
.tp-tabv.tp-tabv-nop .tp-tabv_i {
    height: calc(var(--bld-us) + 4px);
    position: relative
}

.tp-tabv.tp-tabv-nop .tp-tabv_i::before {
    background-color: var(--cnt-bg);
    bottom: 0;
    content: "";
    height: 2px;
